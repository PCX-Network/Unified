...
/**
 * Component bridge implementation for Minecraft 1.21.4-1.21.10 (v1_21_R3).
 *
 * <p>This implementation handles conversion between Adventure components and
 * vanilla Minecraft components for the Pale Garden update versions.
 *
 * <h2>Version Notes</h2>
 * <ul>
 *   <li>Same component structure as 1.21.x</li>
 *   <li>Uses Spigot mappings (last version before Mojang mappings)</li>
 * </ul>
 *
 * @since 1.0.0
 * @author Supatuck
...
public class ComponentBridgeImpl implements ComponentBridge {
    ...
    /**
     * Creates a new component bridge for v1_21_R3.
     */
        ...
        if (vanillaComponentClass == null) {
            try {
                ...
                try {
                    ...
                    throw new IllegalStateException("Could not find vanilla component class for v1_21_R3");
                }
            }
        }
