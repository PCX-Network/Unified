...
/**
 * Component bridge implementation for Minecraft 1.21-1.21.1 (v1_21_R1).
 *
 * <p>This implementation handles conversion between Adventure components and
 * vanilla Minecraft components for the Tricky Trials update versions.
 *
 * <h2>Version Notes</h2>
 * <ul>
 *   <li>Same component structure as 1.20.5+</li>
...
public class ComponentBridgeImpl implements ComponentBridge {
    ...
    /**
     * Creates a new component bridge for v1_21_R1.
     */
        ...
        if (vanillaComponentClass == null) {
            try {
                ...
                try {
                    ...
                    throw new IllegalStateException("Could not find vanilla component class for v1_21_R1");
                }
            }
        }
